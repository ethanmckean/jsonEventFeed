$(function () { // Document ready function
  ...
  $.ajax({
    ...
    success: function (data) { // Run this if there is a successful call
      ...
      linkToHappeningHtml = '<div class = "feed-container center link-to-happening"><a href = "' + linkToHappening + '">Find more Spectrum Center events on Happening @ Michigan</a></div>'
